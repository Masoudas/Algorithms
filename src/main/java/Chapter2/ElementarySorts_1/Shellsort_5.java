 ...
 * and exchange it if necessary. Then we increase i by one, until we reach i < N. Now we decrease h,
 ...
 * 
 * As we show below, we can implement this algorithm, not having to copy the list somewhere else.
 * 
